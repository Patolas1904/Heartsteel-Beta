...
do
    ...
    StandaloneScripts.add("Health Check", function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Patolas1904/Heartsteel-Beta/main/src/healthcheck.lua"))()
    end)
    ...
    UI.UI_DATA = {
        ...
        event = {
            ...
            items = {
                ...
                {type="toggle", key="event_upgrade_EventCoinsMulti", label="Auto More Seashells",
                    callback=function() HS.Event.runAutoEventUpgrades() end},
                {type="toggle", key="event_upgrade_CrownMulti", label="Auto More Crowns",
                    callback=function() HS.Event.runAutoEventUpgrades() end},
                {type="toggle", key="event_upgrade_EventSellMulti", label="Auto Event Sell Boost",
                    callback=function() HS.Event.runAutoEventUpgrades() end},
                {type="toggle", key="event_upgrade_BossHits", label="Auto Event Boss Hits",
                    callback=function() HS.Event.runAutoEventUpgrades() end},
                {type="toggle", key="event_upgrade_EventStrengthMulti", label="Auto Event Strength Boost",
                    callback=function() HS.Event.runAutoEventUpgrades() end},
